...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    ...
    console.log("👉 Plain resetToken (send in email):", resetToken);
    console.log("👉 Hashed resetPasswordToken (stored in DB):", user.resetPasswordToken);

    await user.save({ validateBeforeSave: false });
    console.log("💾 User saved with reset token & expiry:", user.resetPasswordExpire);
